    ...
    void Start()
    {
        ...
        while(wallPosList.Count > 0)//※list.Countは要素数を返す
        {
            ...
            while (wallCheck[0] || wallCheck[1] || wallCheck[2] || wallCheck[3])
            {
                ...
                {
                    case 0:
                        if ((posX < 96 && posZ > 3 && posZ < 96)
                            && (!wallArray[posX + 1, posZ + 2] && !wallArray[posX + 2, posZ + 2] && !wallArray[posX + 3, posZ + 2] && !wallArray[posX + 4, posZ + 2])
                            && (!wallArray[posX + 1, posZ + 1] && !wallArray[posX + 2, posZ + 1] && !wallArray[posX + 3, posZ + 1] && !wallArray[posX + 4, posZ + 1])
                            && (!wallArray[posX + 1, posZ] && !wallArray[posX + 2, posZ] && !wallArray[posX + 3, posZ] && !wallArray[posX + 4, posZ])
                            && (!wallArray[posX + 1, posZ - 1] && !wallArray[posX + 2, posZ - 1] && !wallArray[posX + 3, posZ - 1] && !wallArray[posX + 4, posZ - 1])
                            && (!wallArray[posX + 1, posZ - 2] && !wallArray[posX + 2, posZ - 2] && !wallArray[posX + 3, posZ - 2] && !wallArray[posX + 4, posZ - 2]))
                        {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        if ((posZ < 96 && posX > 3 && posX < 96)
                            && (!wallArray[posX + 2, posZ + 1] && !wallArray[posX + 2, posZ + 2] && !wallArray[posX + 2, posZ + 3] && !wallArray[posX + 2, posZ + 4])
                            && (!wallArray[posX + 1, posZ + 1] && !wallArray[posX + 1, posZ + 2] && !wallArray[posX + 1, posZ + 3] && !wallArray[posX + 1, posZ + 4])
                            && (!wallArray[posX, posZ + 1] && !wallArray[posX, posZ + 2] && !wallArray[posX, posZ + 3] && !wallArray[posX, posZ + 4])
                            && (!wallArray[posX - 1, posZ + 1] && !wallArray[posX - 1, posZ + 2] && !wallArray[posX - 1, posZ + 3] && !wallArray[posX - 1, posZ + 4])
                            && (!wallArray[posX - 2, posZ + 1] && !wallArray[posX - 2, posZ + 2] && !wallArray[posX - 2, posZ + 3] && !wallArray[posX - 2, posZ + 4]))
                        {
